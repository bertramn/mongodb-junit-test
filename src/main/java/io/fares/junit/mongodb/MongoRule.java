...
public class MongoRule implements TestRule {
	...
	/**
	 * @return a functioning mongodb client that can connect to the started
	 *         mongod process
	 */
	 ...
	 * 
	 * @param host
	 *            the machine name or an IP address
	 */
	 ...
	 * 
	 * @param version
	 *            the version as valid mongodb version number
	 * 
	 */
	 ...
	 *            the version as valid mongodb version number
	 * @param syncDelay
	 *            true if the download is to be retrieved with sync delay
	 */
